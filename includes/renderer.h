...
typedef struct s_matlookup {
	void (*f)(int, int, t_data *);
	int (*fi)(int, int, t_data *);
	int (*fie)(int, int, t_data *, int, int, int, int, int);
	void (*fic)(int, int, t_data *, char);
	t_matparam param;
} t_matlookup;

typedef struct s_postprocesslookup {
	void (*f)(int, int, t_data *, int);
	int param;
} t_postprocesslookup;
...
void explosion_calc(int xc, int yc, int x, int y, t_data *data, int id, int res,
					int thougth);
void explosion_circle(int xc, int yc, int r, t_data *data, int id, int res,
					  int thought);
void explode(int x, int y, t_data *data, int radius, int chance, int id,
			 int res, int thought);
...
int	 emulate_solid(int x, int y, t_data *data, int randed, int slide, int force,
				   int inertialchance, int inertialres);
int	 emulate_wetsand(int x, int y, t_data *data, int randed, int slide,
					 int force, int inertialchance, int inertialres);
